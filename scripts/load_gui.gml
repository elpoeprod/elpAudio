...
visualiser.vis[ii]=file_text_read_all(filename_path(argument0)+'visualisers\'+string(iii)+'.gml')
...
//}
/*if me.button=1 {me.x=ini_read_real('Interface','miniguix2',64)
me.y=ini_read_real('Interface','miniguiy2',16)}
if me.button=2 {me.x=ini_read_real('Interface','miniguix3',64)
me.y=ini_read_real('Interface','miniguiy3',16)}*/
i+=1
}
/*if instance_exists(sliderbutton) {
sliderbutton.x=ini_read_real('Interface','sliderx',64)
sliderbutton.y=ini_read_real('Interface','slidery',16)
}
*/
