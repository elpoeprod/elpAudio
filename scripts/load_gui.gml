...
var iii;iii=0
repeat(15) {
if file_exists(working_directory+'\visualisers\vis_'+string(iii)+'.gml') {
global.vis[iii]=file_text_read_all(working_directory+'\visualisers\vis_'+string(iii)+'.gml',' ')
//show_message(global.vis[iii])
file_text_write_all('test.txt',global.vis[iii])
